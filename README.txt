...
4. If it doesn't exist, create a folder called "Mods" inside the Balatro folder

Apologies if this tutorial doesn't work, I don't really know how this stuff works so this might only work for Linux.
